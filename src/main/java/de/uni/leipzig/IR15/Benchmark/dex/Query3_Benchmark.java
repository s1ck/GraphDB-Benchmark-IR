...
public class Query3_Benchmark extends DEXBenchmark {
	...
	/**
	 * Finds all nodes and gets the w1_id, w2_id, sig and freq attributes for
	 * nodes that are neighbors to each other and to a given start node.
	 */
	@Override
	public void run() {
...
//		;
		...
		while (iter1.hasNext()) {
			...
			while (iter2.hasNext()) {
				...
				graph.getAttribute(node1, wordIDAttribute,
