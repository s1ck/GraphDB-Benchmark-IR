...
\usepackage{geometry}
\usepackage{array}					% zentrierte Spalten fester breite
...
Eine dritte Zugriffsvariante besteht mittels  Gremlin\footnote{\url{https://github.com/tinkerpop/gremlin/wiki}}, einer imperativen, an XPath angelehnten Sprache zur Traversierung von Graphen.
...
\begin{table}[ht]
\begin{tabular}{|l||C{3.2cm}|C{3.2cm}|C{3.3cm}|}
	...
	\hline 
	Lizenz & GPL (Community Edition) & Apache License 2.0 & Mehr"-fach"-li"-zen"-sie"-rung (kos"-ten"-freie E"-va"-lu"-a"-tion, kom"-mer"-ziel"-le Nut"-zungs"-li"-zens)	 \\ 
	\hline 
\end{tabular}
